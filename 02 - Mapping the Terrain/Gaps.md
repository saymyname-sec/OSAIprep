...
**What's missing:** Walking `/openapi.json` or `/v1/openapi.yaml` to map every endpoint, parameter, and auth scheme. If this appears on the engagement, use standard REST API recon methodology: read `paths`, `components/schemas`, `securitySchemes`.  
