...
**Action needed:** Add notes from lab observation or adversarial-security course slides.
...
**Status:** Not documented  
**What's missing:** MCP supports both stdio (local process) and HTTP transport. Attack surface differs — stdio tools can't be remotely poisoned without host access; HTTP tools can. Distinction matters for engagement scenarios.  
