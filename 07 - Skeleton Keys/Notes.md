...
```bash
# List snippets
curl -s -H "PRIVATE-TOKEN: glpat-<REDACTED>" \
...
**Scope:** user-dev @ windesk03 → assist01/api02 via MCP filesystem tool  
**Credentials:** `user-dev:<REDACTED>`

**Network:**
```
192.168.219.72  windesk03     3389/RDP, 22, 5985 — Your machine (user-dev)
