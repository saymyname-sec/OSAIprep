...
**What to monitor:** Inbound SSH on port 2222 to DC01 or any domain controller; authentication logs on DC01 for Administrator SSH logon.
...
- **SSH key in agent.log:** Rotate the key immediately; review all SSH sessions to DC01 on port 2222 for the past 72h; audit Administrator account usage.
